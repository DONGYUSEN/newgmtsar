...
echo "fd1 = "
echo ""
echo "# input data level"
echo "# 0: start from L0/raw with pre_proc in stage-1 (default)"
echo "# 1: start from L1/SLC, skip stage-1 and start from stage-2"
echo "data_level = 0"
echo ""
if ($SAT == "S1_TOPS") then
...
echo ""
echo "# separate_focus controls whether stage-2 is split to focus-only"
echo "# 0: default, run focus + alignment in stage-2"
echo "# 1: focus-only mode (stop after L0->L1 focusing, skip alignment)"
echo "# valid SAT: ERS, ENVI, ALOS, CSK_RAW"
echo "# resume alignment after focus-only:"
echo "#   set separate_focus = 0, proc_stage = 2, skip_stage = 1"
echo "separate_focus = 0"
echo ""
echo "#"
echo "#####################################"
